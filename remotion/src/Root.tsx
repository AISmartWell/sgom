...
export const RemotionRoot = () => (
  <>
    ...
    <Composition id="inv-05-rps" component={RPSScene} durationInFrames={d(4)} fps={30} width={1920} height={1080} />
    <Composition id="inv-06-advisor" component={() => <UIScene clip="advisor" startAt={8} kicker="Stage 3 · Autonomous advisor" title="The agent screens the whole field" badge="SPT · US PATENT 8,863,823" bullets={["Ranks every candidate well", "Matches the right restoration technology", "Slot Perforation Technology first"]} />} durationInFrames={d(5)} fps={30} width={1920} height={1080} />
    <Composition id="inv-07-twin" component={() => <UIScene clip="twin" startAt={8} kicker="Stage 4 · Digital twin" title="The forecast stays honest" badge="AUTO-CALIBRATED" bullets={["Live production vs model", "Self-calibrating after every treatment"]} />} durationInFrames={d(6)} fps={30} width={1920} height={1080} />
    <Composition id="inv-08-econ" component={() => <UIScene clip="econ" startAt={8} kicker="Stage 5 · Economics" title="What investors actually buy" badge="CAPITAL · PAYBACK · CASH FLOW" bullets={["Full economic case per recommendation", "Downside modelled next to upside", "Decision-ready, board-ready output"]} />} durationInFrames={d(7)} fps={30} width={1920} height={1080} />
    <Composition id="inv-09-numbers" component={NumbersScene} durationInFrames={d(8)} fps={30} width={1920} height={1080} />
    <Composition id="inv-10-close" component={CloseScene} durationInFrames={d(9)} fps={30} width={1920} height={1080} />
    <Composition
      id="teaser"
