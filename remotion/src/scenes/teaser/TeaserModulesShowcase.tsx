...
// SCENE — MODULES SHOWCASE (8 sec). Real screenshots of platform modules:
// Dashboard (Stage Overview), Oklahoma Pilot (Stage 1), Geophysical Expertise (Stage 8).
const SHOTS = [
  {
    src: "shots/01-dashboard.png",
    stage: "Overview",
    title: "Investor Dashboard",
    sub: "15,847 wells · 847 SPT candidates",
    color: COLORS.accent,
  },
  {
    src: "shots/04-oklahoma-pilot.png",
    stage: "Stage 1",
    title: "Field Scanning",
    sub: "Oklahoma pilot · regional scan",
    color: COLORS.signal,
  },
  {
    ...
    sub: "Well log interpretation",
    color: COLORS.warn,
  },
];

export const TeaserModulesShowcase: React.FC = () => {
    ...
    <AbsoluteFill style={{ background: COLORS.bgDeep }}>
      ...
      <AbsoluteFill style={{ padding: "70px 80px", display: "flex", flexDirection: "column" }}>
        <div style={{ marginBottom: 36 }}>
          ...
          >
            ▍ AI Smart Well · Platform Modules
          </div>
          <div
            style={{
          ...
          >
            One platform. <span style={{ color: COLORS.accent }}>9 stages.</span>
          </div>
        </div>
        ...
        >
          Live SaaS · Multi-tenant · RLS isolated · NVIDIA NIM + Gemini
        </div>
      </AbsoluteFill>
    </AbsoluteFill>
  );
