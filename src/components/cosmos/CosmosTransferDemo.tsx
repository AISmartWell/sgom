        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <CardTitle className="text-xl flex items-center gap-2 flex-wrap">
              ...
              <IntegrationStatusBadge mode="simulation" tooltip="Synthetic logs are generated by a deterministic seeded random walk constrained by FORMATION_DB ranges. Real Cosmos Transfer (video world model) requires GPU H100 + custom log↔tensor adapter — Phase I R&D." />
            </CardTitle>
            <CardDescription>
