...
const steps = [
  ...
  },
  {
    ...
    subtitle: "NVIDIA Vision",
    icon: Microscope,
    color: "hsl(var(--warning))",
    duration: "2–5 мин / образец",
    description:
      "Компьютерное зрение NVIDIA Vision анализирует фотографии керна: определяет тип породы, пористость, трещиноватость и минеральный состав.",
