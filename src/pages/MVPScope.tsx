...
const mvpModules = [
  ...
  },
  {
    ...
    icon: Settings,
    description: "Informational module — SPT treatment parameters input & visualization (provided by Maxxwell Production)",
    emoji: "⚙️",
    inputs: ["Treatment parameters from Maxxwell Production engineer", "Selected candidate from Stage 4"],
    outputs: ["Slot pattern visualization on wellbore", "Treatment parameters reference card", "Equipment specifications display"],
    acceptance: ["Slot placement visualization on wellbore", "Manual parameter entry by Maxxwell engineer", "Read-only reference view for operators"],
    budget: 5000,
    dependencies: ["AI Well Selection & Ranking"],
  },
  {
