...
const mvpModules = [
  ...
  // SPT Parameters merged into EOR Optimization as informational tab
  {
    stage: "Stage 6",
  ...
  },
  {
    ...
    icon: Brain,
    description: "AI-driven Enhanced Oil Recovery optimization — central MVP pipeline hub. Includes SPT Parameters tab (treatment visualization provided by Maxxwell Production)",
    emoji: "🧠",
    inputs: ["Results from all Stage 1–7 modules", "Core Analysis data", "SPT treatment parameters from Maxxwell Production engineer"],
    outputs: ["EOR optimization summary report", "Final treatment recommendations", "Dashboard with key metrics", "SPT slot pattern visualization"],
    acceptance: ["Data aggregation from all modules", "Unified KPI dashboard", "PDF report generation", "SPT Parameters informational tab with slot visualization"],
    budget: 20000,
    dependencies: ["Field Scanning", "Data Classification", "Cumulative Analysis", "AI Well Selection & Ranking", "Economic Analysis", "Geophysical Expertise", "Core Analysis (CV)"],
  },
  {
    stage: "Core",
