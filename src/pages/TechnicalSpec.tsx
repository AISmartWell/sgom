          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>GPU-accelerated Monte Carlo (tensor-network variance reduction, research prototype) — economic risk assessment</li>
          ...
          <div className="space-y-4">
            {[
               ...
               { icon: "💵", name: "Economic Analysis (Stage 7)", route: "/dashboard/economic-analysis",
                 desc: "Full economic evaluation with interactive scenario modeling. Per-well and portfolio metrics: ROI (5-year), payback period, annual gross/net profit. Monte Carlo simulation (50,000 seeded iterations in a Web Worker) with P10/P50/P90. Tornado Chart sensitivity analysis. Cumulative net profit projection (60-month). Net Profit = (Added Production × Oil Price − OPEX/bbl) × 365 × Timeline − Treatment Cost." },
               { icon: "⚡", name: "GPU-Accelerated Monte Carlo (research prototype)", route: "/dashboard/economic-analysis",
                 desc: "Variance-reduction research prototype inside the Economic Analysis module: an amplitude-estimation style estimator emulated with tensor networks on GPU (CPU fallback). Benchmarked against the classical O(1/√N) Monte Carlo baseline. Interactive controls: state-space size, Oil Price volatility, CAPEX volatility. ROI distribution histogram and convergence comparison chart. No quantum hardware is used and no quantum speedup is claimed." },
