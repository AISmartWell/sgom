            ...
            {[
              ...
              { icon: "💰", name: "Financial Calculator", route: "/dashboard/financial",
               ...
               { icon: "⚙️", name: "SPT Parameters (Stage 7)", route: "/dashboard/spt-parameters",
                   desc: "Cutting program generation for well recompletion via slot-perforation technology. 5-stage pipeline: Well Data Input → Cutting Program Generation → Equipment Specifications → Slot Design Optimization → Service Report. Interactive slot geometry controls (length, width, slots/row, row spacing) with real-time radar chart for design optimization (flow area, slot density, coverage, structural integrity, flow rate, efficiency). Generates complete service program document with cutting distribution by zone, equipment list, and estimated flow capacity. Key calculations: Open Area = N_slots × L_slot × W_slot; Flow Capacity = Open Area × 42 × 24 bbl/day." },
