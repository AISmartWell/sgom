    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <Tabs value={tab} onValueChange={setTab}>
        ...
        <TabsContent value="commercial" className="space-y-4 mt-4">
          {/* Pricing Rationale */}
          <Card>
            <CardHeader><CardTitle className="text-sm">Pilot Commercial Terms</CardTitle></CardHeader>
            <CardContent>
              <Table>
                <TableHeader><TableRow><TableHead>Item</TableHead><TableHead>Detail</TableHead></TableRow></TableHeader>
                <TableBody>
                  <TableRow><TableCell className="font-medium">Engagement type</TableCell><TableCell>Fee-for-Analysis (no operational risk transfer)</TableCell></TableRow>
                  <TableRow><TableCell className="font-medium">Price / well</TableCell><TableCell>$50–150 (volume tier — 500 wells)</TableCell></TableRow>
                  <TableRow><TableCell className="font-medium">Pilot ceiling</TableCell><TableCell>$45,000 fixed-fee (500 wells, 28 days)</TableCell></TableRow>
                  <TableRow><TableCell className="font-medium">Payment</TableCell><TableCell>30% kickoff · 40% on Week-2 milestone · 30% on final delivery</TableCell></TableRow>
                  <TableRow><TableCell className="font-medium">IP / data</TableCell><TableCell>Aramco retains 100% of input + output data; AI Smart Well retains models / prompts</TableCell></TableRow>
                  <TableRow><TableCell className="font-medium">Success criteria</TableCell><TableCell>≥85% reconciliation match rate · 4 SPT-Ready dossiers · workshop sign-off</TableCell></TableRow>
                  <TableRow><TableCell className="font-medium">Scale-out option</TableCell><TableCell>SaaS subscription post-pilot — $25–60 / well / year (10K+ wells)</TableCell></TableRow>
                </TableBody>
              </Table>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-sm flex items-center gap-2">
                ...
                Software License Breakdown — Traditional vs AI Smart Well
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Traditional field studies by SLB / Halliburton include proprietary software licenses that account for 15–25% of total project cost. Below is a detailed comparison of what the operator effectively pays for.
              </p>
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-muted/40">
                      <TableHead className="w-[180px]">Software</TableHead>
                      <TableHead>Vendor</TableHead>
                      <TableHead>Purpose</TableHead>
                      <TableHead className="text-right">License Cost</TableHead>
                      <TableHead>AI Smart Well</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    <TableRow>
                      <TableCell className="font-medium text-sm">Petrel</TableCell>
                      <TableCell className="text-xs">Schlumberger (SLB)</TableCell>
                      <TableCell className="text-xs text-muted-foreground">Geological modeling, structural interpretation, 3D reservoir framework</TableCell>
                      <TableCell className="text-right font-mono text-xs">$80,000 / seat / yr</TableCell>
                      <TableCell className="text-xs text-success">Not needed — cloud-native geological DB</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium text-sm">Techlog</TableCell>
                      <TableCell className="text-xs">Schlumberger (SLB)</TableCell>
                      <TableCell className="text-xs text-muted-foreground">Well log processing, petrophysical interpretation (Vsh, φ, Sw, k)</TableCell>
                      <TableCell className="text-right font-mono text-xs">$40,000 / seat / yr</TableCell>
                      <TableCell className="text-xs text-success">Replaced by open-source Python stack + AI CV</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium text-sm">Eclipse</TableCell>
                      <TableCell className="text-xs">Schlumberger (SLB)</TableCell>
                      <TableCell className="text-xs text-muted-foreground">Reservoir simulation, fluid flow modeling, history matching</TableCell>
                      <TableCell className="text-right font-mono text-xs">$60,000 / seat / yr</TableCell>
                      <TableCell className="text-xs text-success">Not needed — analytical Arps DCA + Monte Carlo</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium text-sm">CMG / IMEX / STARS</TableCell>
                      <TableCell className="text-xs">Computer Modelling Group</TableCell>
                      <TableCell className="text-xs text-muted-foreground">Thermal / chemical EOR simulation, compositional modeling</TableCell>
                      <TableCell className="text-right font-mono text-xs">$50,000 / seat / yr</TableCell>
                      <TableCell className="text-xs text-success">Not needed — EOR screening uses analytical proxy models</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium text-sm">Kappa Workstation</TableCell>
                      <TableCell className="text-xs">Kappa Engineering</TableCell>
                      <TableCell className="text-xs text-muted-foreground">DCA, pressure transient analysis, production interpretation</TableCell>
                      <TableCell className="text-right font-mono text-xs">$30,000 / seat / yr</TableCell>
                      <TableCell className="text-xs text-success">Replaced by custom DCA engine (Python + scipy)</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium text-sm">PowerLog / IP</TableCell>
                      <TableCell className="text-xs">Halliburton</TableCell>
                      <TableCell className="text-xs text-muted-foreground">Log analysis, deterministic petrophysics, lithology prediction</TableCell>
                      <TableCell className="text-right font-mono text-xs">$25,000 / seat / yr</TableCell>
                      <TableCell className="text-xs text-success">Replaced by open-source LAS parser + AI segmentation</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium text-sm">DecisionSpace</TableCell>
                      <TableCell className="text-xs">Halliburton</TableCell>
                      <TableCell className="text-xs text-muted-foreground">Integrated geoscience platform, seismic-to-simulation workflow</TableCell>
                      <TableCell className="text-right font-mono text-xs">$45,000 / seat / yr</TableCell>
                      <TableCell className="text-xs text-success">Not needed — modular cloud microservices</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium text-sm">MATLAB</TableCell>
                      <TableCell className="text-xs">MathWorks</TableCell>
                      <TableCell className="text-xs text-muted-foreground">Custom algorithms, statistics, optimization scripts</TableCell>
                      <TableCell className="text-right font-mono text-xs">$15,000 / seat / yr</TableCell>
                      <TableCell className="text-xs text-success">Replaced by Python (numpy, pandas, scipy)</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium text-sm">ArcGIS Pro</TableCell>
                      <TableCell className="text-xs">Esri</TableCell>
                      <TableCell className="text-xs text-muted-foreground">Spatial mapping, contouring, GIS analysis of well locations</TableCell>
                      <TableCell className="text-right font-mono text-xs">$7,000 / seat / yr</TableCell>
                      <TableCell className="text-xs text-success">Replaced by Leaflet + deck.gl (open-source)</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium text-sm">Microsoft 365 E5</TableCell>
                      <TableCell className="text-xs">Microsoft</TableCell>
                      <TableCell className="text-xs text-muted-foreground">Office suite, Teams, SharePoint for report collaboration</TableCell>
                      <TableCell className="text-right font-mono text-xs">$420 / seat / yr</TableCell>
                      <TableCell className="text-xs text-muted-foreground">Client-side only — AI Smart Well does not charge for Office</TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-4 mt-2">
                <Card className="border-border/50 bg-muted/20">
                  <CardContent className="pt-4">
                    <p className="text-[10px] uppercase text-muted-foreground tracking-wider mb-1">Traditional Stack</p>
                    <p className="text-2xl font-bold text-amber-400">$352K+</p>
                    <p className="text-xs text-muted-foreground">Annual licenses per 5-seat team</p>
                    <p className="text-xs text-muted-foreground mt-1">Amortized into every project</p>
                  </CardContent>
                </Card>
                <Card className="border-border/50 bg-muted/20">
                  <CardContent className="pt-4">
                    <p className="text-[10px] uppercase text-muted-foreground tracking-wider mb-1">AI Smart Well Stack</p>
                    <p className="text-2xl font-bold text-success">$0</p>
                    <p className="text-xs text-muted-foreground">Per-seat proprietary licenses</p>
                    <p className="text-xs text-muted-foreground mt-1">Open-source + cloud compute only</p>
                  </CardContent>
                </Card>
                <Card className="border-border/50 bg-muted/20">
                  <CardContent className="pt-4">
                    <p className="text-[10px] uppercase text-muted-foreground tracking-wider mb-1">Compute Cost (500 wells)</p>
                    <p className="text-2xl font-bold text-primary">~$5–8</p>
                    <p className="text-xs text-muted-foreground">Per 100 wells batch (AWS GPU)</p>
                    <p className="text-xs text-muted-foreground mt-1">vs. $400–500/hr petrophysicist</p>
                  </CardContent>
                </Card>
              </div>

              <div className="text-xs text-muted-foreground space-y-1">
                <p><span className="text-foreground font-medium">Why the difference matters:</span> SLB and Halliburton embed software license amortization into every project. A 5-engineer team requires $350K+/year in seat licenses alone — these costs are distributed across 4–6 projects annually, adding $15–25K per study regardless of well count.</p>
                <p>AI Smart Well replaces proprietary suites with: (1) <span className="text-foreground">open-source Python</span> (pandas, scipy, numpy) for numerical work, (2) <span className="text-foreground">cloud GPU</span> (pay-per-use, no idle seats), (3) <span className="text-foreground">AI models</span> (NVIDIA NIM, Gemini) called via API — no local install.</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-success/30 bg-success/5">
            <CardContent className="pt-4 text-sm">
              <p className="font-semibold text-success mb-2">Next Step</p>
              <p className="text-muted-foreground">
                Sign mutual NDA → Aramco transfers anonymized 500-well CSV + sample LAS (5 wells) →
                Week-1 kickoff with formation DB extension and reconciliation calibration.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
