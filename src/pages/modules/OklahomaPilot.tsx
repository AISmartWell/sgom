        ...
        <div ref={reportRef}>
          <Card className="mt-6 border-success/30 glass-card animate-fade-in">
            ...
            <div className="text-center text-xs text-muted-foreground pt-4 border-t border-border/30">
              <p>Generated by SGOM (SGOM Platform) — Powered by SPT Technology (Patent US 8,863,823)</p>
              <p>Well Screening Pilot ({pilotState}) Analysis — {new Date().toLocaleDateString()} — © {new Date().getFullYear()} Maxxwell Production</p>
            </div>
          </CardContent>
          </Card>
        </div>
